...
def reflect(filename):
    ...
    for y in range(img.height):
        for x in range(img.width):
            ...
            bp_top = b_img.get_pixel(x, y)
            bp_top.red = imgp.red
            bp_top.green = imgp.green
            bp_top.blue = imgp.blue
            bp_bottom = b_img.get_pixel(x, b_img.height-1-y)
            bp_bottom.red = imgp.red
            bp_bottom.green = imgp.green
            bp_bottom.blue = imgp.blue
    return b_img
